...
<body>
				...
				<div class="form-wrapper align-items-center">
					<div class="form sign-up">
						<div class="input-group">
							...
							<input type="text" id="memberId" placeholder="Username"> 
							<span class='button'>
								<input type="button" id="checkId" data-value="No" onclick="idCheck()" value="중복체크">
							</span>
						</div>
						<div class="input-group">
							<i class='bx bx-mail-send'></i> <span><input type="text"
						...
						<div class="input-group">
							<i class='bx bxs-name'></i> <input type="text" placeholder="Name">
						</div>
						<div class="input-group">
							<i class='bx bxs-tel'></i> <input type="Tel" placeholder="Tel">
						</div>
						<div class="input-group">
							<i class='bx bxs-addr'></i> <input type="text"
								id="sample6_postcode" placeholder="우편번호"> <span
								class='button'><input type="button"
								onclick="sample6_execDaumPostcode()" value="우편번호 찾기"></span> <input
	...
	function htmlProcess(data) {
		if(data == 'Yes'){
			...
			document.getElementById("checkId").data("value") = "Yes";
		}else {
			alert(document.getElementById("memberId").value + "\n 이미 사용하는 아이디 입니다.");
